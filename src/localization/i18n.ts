...
const messages: Record<string, MessageDict> = {
  'zh-CN': {
    ...
    'label.lang': '语言:',
    'label.theme': '主题:',
    'theme.select.title': '切换深色/浅色模式',
    'theme.system': '跟随系统',
    'theme.light': '浅色',
    'theme.dark': '深色',
    'toolbar.move.title': '拖动移动工具栏分组',
    'tab.close.title': '关闭此动画',
    'tab.switch.title': '切换到 {name}',
  ...
  'en': {
    ...
    'btn.zoomReset': 'Reset view',
    'btn.zoomReset.title': 'Reset view',
    'label.size': 'Export:',
    'label.size.title': 'PNG / APNG / WebP export size (width × height)',
    'size.scale.title': 'Export scale',
    'size.scale.custom': 'Custom',
    ...
    'label.lang': 'Lang:',
    'label.theme': 'Theme:',
    'theme.select.title': 'Switch light / dark mode',
    'theme.system': 'System',
    'theme.light': 'Light',
    'theme.dark': 'Dark',
    'toolbar.move.title': 'Drag to move toolbar group',
    'tab.close.title': 'Close this animation',
    'tab.switch.title': 'Switch to {name}',
